public class Chessboard {
	...
	public String toString () {
		StringBuilder rtn = new StringBuilder("     1  2  3  4  5  6  7  8");
		rtn.append(System.getProperty("line.separator"));
		char row = 'a';
		for(int i = 0; i < 8; i++)
		{
			rtn.append(" " + (char)(row + i) + "  ");
	...
	public class PawnB extends Chesspiece { 
		public PawnB (char color , char name) { 
			super (color , name); 
		}
		public PawnB() {
		}
		public void markReachableFields () {
			...
			if(column == 7 && Chessboard.this.isValidField(row,col1)) {
				int r = row - FIRST_ROW;
	...
	public class PawnW extends Chesspiece { 
		public PawnW (char color , char name) { 
			super (color , name); 
		}
		public PawnW() {
		}
		public void markReachableFields () {
			...
			byte col1 = (byte) (column + 2);
			if(column == 2 && Chessboard.this.isValidField(row,col1)) {
				int r = row - FIRST_ROW;
				int c = col1 - FIRST_COLUMN;
				Chessboard.this.fields[r][c].mark();
			}
